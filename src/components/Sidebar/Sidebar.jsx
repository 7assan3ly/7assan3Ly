  ...
  return (
    <div className="sidebar">
        ...
        <nav className='navLinks'>
            <NavLink exact="true" activeclassname="active" to="/7assan3Ly">
                <FontAwesomeIcon icon={faHome} color="#bcb7b7" />
            </NavLink>

            <NavLink exact="true" activeclassname="active" className="aboutLink" to="/7assan3Ly/about">
                <FontAwesomeIcon icon={faUser} color="#bcb7b7" />
            </NavLink>

            <NavLink exact="true" activeclassname="active" className="portfolioLink" to="/7assan3Ly/portfolio">
                <FontAwesomeIcon icon={faSuitcase} color="#bcb7b7" />
            </NavLink>

            <NavLink activeclassname="active" className="contactLink" to="/7assan3Ly/contact">
